...
package com.sportClub.domain.Model.classes.ImmutableClasses.Sport_records;

import com.sportClub.domain.Model.Interfaces.Sport_Records;
...
public final class Rugby_Records implements Sport_Records{
    ...
    private int draws;
     ...
     public Rugby_Records(String division,int ageGroup,int wins,int loses,int draws)            
    {        
